  ...
  function install(doc, win, buttonId){
    ...
    function ensureOverlay(){
      ...
      overlay.innerHTML=
        ...
        '<div class="xyws-top"><div class="xyws-topbar"><button class="xyws-topbtn" data-a="close">← 返回</button><div class="xyws-brand"><b>星 海 工 坊</b><small>WORKSHOP OF THE COVENANT</small></div><button class="xyws-topbtn" data-go="mine">我的</button></div><div class="xyws-policy" role="note" aria-label="内容规范"><span class="xyws-policy-badge" aria-hidden="true">18−</span><span class="xyws-policy-text"><b>禁止未成年相关违规内容</b>：严禁发布、传播涉及未成年人的色情、性暗示、剥削或暴力描写；违者删稿并封禁账号。</span></div></div>'+
        '<div class="xyws-main">'+
          ...
          '<section class="xyws-screen" data-screen="create"><div class="xyws-hero"><small>✦ 发布到星海</small><h3>你想分享什么？</h3><p>选择要发布的类型。上传前请确认作品不含任何涉及未成年人的违规描写。</p></div><div class="xyws-creategrid">'+
